          ...
          <!--Add Bus form-->
              <form role="form" action="{{ url("/update_admin_booking/{$booking->booking_id}") }}" method="POST" style="margin-block: 20px; margin-left: 20px;">
                ...
                <div class="row">
                  ...
                  <div class="col">
                      <div class="mb-3 pt-0">
                        <select id="number_passengers" name="number_passengers" class="form-select">
                ...
                <div class="row">
                  ...
                  <div class="col">
                      <div class="mb-3 pt-0">
                        <select id="number_children" name="number_children" class="form-select">
                ...
                <div class="row">
                  ...
                  <div class="col">
                        <input type="text" id="contact_person" name="contact_person" class="form-control" value="{{$booking->contact_person}}" required/>
                  </div>
                </div>
                <br>
                <div class="row">
                  ...
                  <div class="col">
                      <div class="mb-3 pt-0">
                        <select id="luggage_over" name="luggage_over" class="form-select">
